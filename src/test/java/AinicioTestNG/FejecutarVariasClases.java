 ...
 * 
 *  supongamos que tenemos 3 archivos que tienen pruebas y queremos que sólo se ejecuten 2 archivos.
 *  Para hacer esto debemos crear un archivo .xml y configurarlo. Yo lo he llamado "ejecutadorTest.xml" 
 *  
 * 				<?xml version="1.0" encoding="UTF-8"?>
				<!DOCTYPE suite SYSTEM "http://testng.org/testng-1.0.dtd">
				<suite name="conjunto de no se que">
				<test name=" conjunto ">
				<classes>
...
public class FejecutarVariasClases {
